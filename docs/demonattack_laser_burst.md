...
The table uses human-readable gameplay wave numbers 1–12.  
The original ALE uses zero-based internal wave indices 0–11, so gameplay
Wave 1 corresponds to ALE index 0 and gameplay Wave 12 corresponds to
ALE index 11.
